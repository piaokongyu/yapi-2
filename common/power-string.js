...
function handleOriginStr(str, handleValueFn) {
  ...
  str = str.replace('\\' + argsSeparateChar, aUniqueCommaStringNotFoundInData)
  str = str.split(segmentSeparateChar)
  str = str.map(handleSegment)
  str = str.reduce(execute, null)
  str = str.toString();
  return str;
}
